...
variable "scope_key1_variable_display_name" {
  ...
  default     = "SuricataLogsDataSource"
}
...
variable "scope_key_variable_display_name" {
  ...
  default     = "SyslogMessagesDataSource"
}
...
variable "default_scope_value2" {
  type        = string
  description = "The default scope value of scope_key2_variable_display_name variable"
  default     = ""
}

variable "scope_key2_variable_display_name" {
  type        = string
  description = "ZeekLogsDataSource"
  default     = "Logsdatasource2"
}
